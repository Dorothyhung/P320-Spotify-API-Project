...
function AudioFeatures(props) {
  ...
  return (
   ...
   <br />
      ...
      <div className='container-fluid d-flex flex-column align-items-center justify-content-center text-white pb-5 pt-5 px-5'>
      <h1 className='green'>Audio Features</h1>
      {audioFeatures && track ? (
